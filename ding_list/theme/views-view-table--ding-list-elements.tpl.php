...
<table <?php if ($classes): print 'class="' . $classes . '" '; endif; ?><?php print $attributes; ?>>
   <?php if (!empty($title) || !empty($caption)): ?>
    <caption><p><?php print $caption . $title; ?></p></caption>
  <?php endif; ?>
  <?php if (!empty($header)): ?>
    <thead>
      <tr>
  ...
  <tbody>
    <?php foreach ($rows as $row_count => $row): ?>
      <tr <?php if ($row_classes[$row_count]): print 'class="' . implode(' ', $row_classes[$row_count]) . '"'; endif; ?> <?php if ($row_attributes[$row_count]): print drupal_attributes($row_attributes[$row_count]); endif; ?>>
